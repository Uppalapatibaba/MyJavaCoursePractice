...
class M8
{
	public static void main(String[] args)
	{
        ...
        //Thread-0 trying to access s1 object's test1()
		Thread0 t1 = new Thread0(s1);
		t1.start();
        
		//Thread-1 trying to access s1 object's test1()
		Thread1 t2 = new Thread1(s1);
		t2.start();

		Util.sleep(5000);

		System.out.println("main Thread after 5sec sleep");

        //main Thread trying to access s1 object's test2()
		s1.test2();
	}
}